...
module.exports.security = {
  ...
  ****************************************************************************/
  ...
  /*cors: {
    allRoutes: true,                  // apply to all routes, including POST
    allowOrigins: ['https://example.com', 'http://localhost:1337'], // whitelist specific origins
    allowRequestMethods: 'GET,POST,PUT,DELETE,OPTIONS,HEAD',
    allowRequestHeaders: 'content-type,authorization',
    allowCredentials: false          // set to true only if you need cookies
  },*/
  csrf: true
